...
class Payload():
    def __init__(self, nome, chavepix, valor, cidade, txtId, diretorio='api/static/assets/'):
    ...
    def gerarQrCode(self, payload, diretorio):
        ...
        self.qrcode.save(os.path.join(dir, 'qrcode.png'))


app = Flask(__name__)

app.config['SECRET_KEY'] = "pix"
...
def gerar():
    ...
    valor = valor + '.0'
    payload = Payload('Habacuque Gosch', '13012155970', '{}'.format(valor), 'palhoça', 'LOJA01')
